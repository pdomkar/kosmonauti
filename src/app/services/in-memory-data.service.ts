...
export class InMemoryDataService implements InMemoryDbService {
    createDb() {
        const cosmonauts = [
            ...
            {id: 8, name: 'Petr', surname: 'Rašek', born: {date: {year: 1925, month: 11, day: 21}}, power: 'tajný'},
            {id: 9, name: 'Honza', surname: 'Pešek', born: {date: {year: 1949, month: 4, day: 22}}, power: 'čich'},
